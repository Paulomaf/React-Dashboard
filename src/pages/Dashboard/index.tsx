...
const Dashboard: React.FC = () => {
  ...
  const message = useMemo(() => {
    if(totalBalance < 0) {
      ...
      return {
        title: "Ops!",
        description: "Neste mês, você há regitros",
        footerText: "Parece que neste mês e ano você não fez nenhum registro",
        icon: sadImg
      }
    }
      ...
      return {
        ...
        footerText: "Cuidado. No próximo mês tente poupar",
        icon: sadImg
      }
    } else {
      return {
    ...
    <Container>
      ...
      <Content>
        <WalletBox title="saldo" amount={totalBalance} color="#4E41F0" 
                  footerlabel="atualizado com base nas entrafas e saídas" icon="dolar" />
        <WalletBox title="entradas" amount={totalGains} color="#F7931B" 
                  footerlabel="atualizado com base nas entrafas e saídas" icon="arrowUp" />
        <WalletBox title="saídas" amount={totalExpenses} color="#E44C4E" 
                  footerlabel="atualizado com base nas entrafas e saídas" icon="arrowDown" />
